...
export default function AboutSection() {
  ...
  return (
    ...
    >
      ...
      <div 
        ref={ref}
        className={`max-w-3xl mx-auto flex flex-col items-center justify-center px-4 relative z-10 h-full ${
          isMobile 
      ...
      >
        ...
        <div className="max-w-2xl w-full rounded-2xl sm:rounded-3xl  p-2 sm:p-6 md:p-10 mb-4 sm:mb-6 md:mb-10 mx-auto flex flex-col items-center">
