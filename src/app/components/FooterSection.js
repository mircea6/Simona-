        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://www.anpc.ro" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-pink-600 transition-colors">
                  ANPC
                </a>
              </li>
            </ul>
            ...
            <div className="flex gap-4">
              <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer">
                <Image 
                  width={175} 
                  height={50} 
                  src="https://victoriadance.ro/wp-content/uploads/2023/09/SOL-1.svg" 
              ...
              <a href="https://anpc.ro/ce-este-sal/" target="_blank" rel="noopener noreferrer">
                <Image 
                  width={175} 
                  height={50} 
                  src="https://victoriadance.ro/wp-content/uploads/2023/09/SAL.svg" 
                  alt="ANPC SOLUȚIONAREA ALTERNATIVA A LITIGIILOR" 
                  className="attachment-large size-large"
                />
              </a>
            </div>
