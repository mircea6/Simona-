  ...
  return (
    <section className="hero relative flex flex-col items-center justify-center text-center w-full flex-1 min-h-[calc(100vh-80px)] text-white">
      <div className="container w-full flex flex-col items-center justify-center px-2 sm:px-4">
        <h1 className="hero-title text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[4.5rem] font-extrabold mb-2 sm:mb-3 md:mb-4 drop-shadow-lg text-white font-serif leading-tight px-2" style={{ fontFamily: 'Courgette, cursive' }}>
          Bine ai venit la{" "}
          <span className="accent text-pink">Mimi Dance Academy</span>
        </h1>
        <p className="lead text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl mb-4 sm:mb-6 md:mb-8 lg:mb-10 drop-shadow text-white/90 max-w-2xl mx-auto font-serif px-2 sm:px-4" style={{ fontFamily: 'Dancing Script, cursive' }}>
          Locul unde dansul prinde viață în nuanțe de baby blue și roz.
        </p>
