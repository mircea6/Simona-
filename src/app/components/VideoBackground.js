...
export default function VideoBackground() {
  ...
  return (
    <video
      ...
      playsInline
      preload="auto"
      className="hero-video absolute top-0 left-0 w-full h-full object-cover z-0 pointer-events-none blur-[90px] sm:blur-[90px] md:blur-[10px] brightness-90 opacity-90 transition-all"
    >
